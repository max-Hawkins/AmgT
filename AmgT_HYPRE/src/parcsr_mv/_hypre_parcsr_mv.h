...
extern "C" {
#endif
   extern double time_spmv;
   extern double time_spmv_sum;
   extern double time_spmv_preprocess;
   extern double time_spgemm_all;
   extern int spmv_times;
 ...
 *--------------------------------------------------------------------------*/
#define hypre_ParCSRMatrixLevel(matrix) ((matrix)->coasen_level)
