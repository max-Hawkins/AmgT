 ...
 */
double cusparse_spgemm_time = 0.0;
#include <sys/time.h>
HYPRE_Int
                                        ...
                                        HYPRE_Complex **d_c_out)
{
   ...
   double time_spgemm_kernel_time = (t2.tv_sec - t1.tv_sec) * 1000.0 + (t2.tv_usec - t1.tv_usec) / 1000.0;
   ...
   cusparse_spgemm_time += time_spgemm_kernel_time;
